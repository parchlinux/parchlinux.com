      ...
      <div className="grid grid-cols-12 mb-8">
        <div className="xl:col-span-7 sm:col-span-8 col-span-12 flex items-center sm:order-first order-last">
          <div className="flex flex-col xl:gap-7 lg:gap-5 gap-3 sm:items-start items-center">
            ...
            <div className="grid grid-cols-4 xl:gap-4 md:gap-2 sm:gap-5 gap-3 mb-4 xl:order-2 order-last 2xl:pr-48 xl:pr-32 sm:pr-16 w-full">
            ...
            <p
              className="text-justify sm:w-5/6 sm:text-[0.99rem] text-xs sm:line-clamp-3 xl:order-last sm:mb-0 mb-4"
              style={{}}
            >
