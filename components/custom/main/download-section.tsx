  ...
  return (
    <div className="container max-w-7xl mx-auto px-4">
      <div className="flex flex-col md:flex-row items-center md:items-center py-16 gap-10 md:gap-0">
        ...
        <div className="md:col-span-8 flex flex-col justify-center md:items-start items-center gap-6 md:gap-14 text-center md:text-start order-2 md:order-1 w-full">
